...
function sejaBemVindo(){
    let digiteSeuCpf = document.querySelector("#cpf").value;
    let digiteSuaDataDeNascimento = document.querySelector("#dataDeNascimento").value;
let CpfDigitado = "";
let dataDeNascimentoDigitada = "";
...
switch(digiteSuaDataDeNascimento) {
    case '1':
        dataDeNascimentoDigitada = ""
        break;
